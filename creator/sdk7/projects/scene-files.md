...
After [creating a new scene](../getting-started/sdk-101.md), the scene folder will have a series of files with default content.
...
For more information see [scene metadata](../projects/scene-metadata.md#metadata).
