...
* [iOS curation](../ios-curation.md) — how iOS content curation works and how to submit your scene or world for review.
...
* [ ] Your UI is sized large enough for touch — follow the [UI best practices](../ui-best-practices.md).
...
* [ ] Your scene's [Performance](../optimize-performance.md) score is above 80% across all graphic profiles on a mid-range phone — see [Hardware Requirements](../hardware-requirements.md) for reference devices.
