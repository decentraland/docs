...
* Rule out that the problem could be caused by how your scene is built. See [Debug in Preview](../debugging/debug-in-preview.md) and [Debug in Prod](../debugging/debug-in-prod.md) for tips.
