...
{% hint style="info" %}
**💡 Note**: `PointerLock` is a desktop-client concept (locked vs. unlocked mouse cursor). It has no effect on the [mobile app](../../../build-for-mobile/mobile-client/), where input is touch-based.
{% endhint %}
