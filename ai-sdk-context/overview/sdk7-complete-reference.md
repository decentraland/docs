...
## Free Asset Catalogs
- **3D Models — OpenDCL Catalog (8,800+ models)**: `Skills/add-3d-models/references/model-catalog.md` — optimized 3D models with descriptions, dimensions, animations, and R2 download URLs (generated by `catalog-builder` pipeline)
