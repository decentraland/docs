...
For spring bones to work nicely, they have to be parented to one of the avatar's original bones. For hairs and earrings, for example, the bone on top of the hierarchy should be parented to ***Avatar_Head***. For scarves, parenting the chain to the ***Avatar_Neck*** is a nice idea. For skirts, maybe ***Avatar_Hips*** or ***Avatar_LeftUpLeg/Avatar_RightUpLeg*** could do the trick.
