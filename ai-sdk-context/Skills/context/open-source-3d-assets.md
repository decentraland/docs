...
Scan this to identify which collection(s) to read. Each entry links to its section below.

| Collection | Count | Theme |
|---|---|---|
| MomusPark | 72 | Nature park, Greek ruins, ancient columns, trees, foliage |
| Medieval Fair | 35 | Medieval festival, market stalls, banners, weapons, tents |
| Chromatic Chaos | 56 | Vaporwave / 80s retro, neon, synthwave aesthetic |
| Tomb Chaser 1 | 55 | Egyptian pyramid, desert ruins, hieroglyphics, traps |
| Tomb Chaser 2 | 50 | Neon Japanese pagoda, night city, lanterns |
| Christmas | 40 | Holiday seasonal, snow, trees, gifts, decorations |
| Avatar Show | 48 | Interview studio, chairs, cameras, screens, furniture |
| Aero System | 15 | Sci-fi transit, floating platforms, futuristic transport |
| Crystal Crossroads | 64 | Surrealist desert, sci-fi tech, crystal formations |
| Transit | 23 | Retro-futuristic transport station, kiosks, signage |
| CA World | 68 | Classical mansion, European architecture, columns, arches |
| Lunar Year | 52 | Asian-inspired, Lunar New Year, lanterns, dragons |
| ABM | 54 | Blockchain museum, futuristic domes, exhibits |
| Avatar Garden | 84+ | Gauguin-inspired landscape, lush tropical, painterly |
| Towers | 84+ | Multi-theme tower gallery, art deco, mixed styles |
| Trash Polka | 30 | Industrial urban, graffiti, raw concrete, street art |
| Cryptoavatars Retro Booth | 54 | 80s Japanese street booth, neon, arcade, retro |
| XYZ Creatures | 60 | Rigged animated creatures — ready for Animator use |
...
IMPORTANT: When placing a flat ground entity, always set the y position to 0.01 or higher so that it doesn't z-fight with the default ground.
