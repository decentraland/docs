...
As a rule of thumb, always write your code inside `main()` (or in other functions that are referenced indirectly by main). See [Scene lifecycle](coding-scenes.md#scene-lifecycle) for more details.

Run the scene preview: you should now see two avocados now, the one you added in the Scene Editor and the one you added via code.
