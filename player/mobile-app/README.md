---
description: Decentraland on iOS and Android.
---
...
{% hint style="warning" %}
**UK users:** the iOS and Android apps are not currently available in the United Kingdom due to CryptoAssets and Crypto Gaming Regulations.
{% endhint %}
...
* [In-World Overview](../decentraland-in-world/overview.md)
